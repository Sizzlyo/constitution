...
Each Intro Process participant, after the first week, is given two weeks to obtain signatures from Active, Intro, Alumni, Honorary, and Advisory Members.
...
\begin{enumerate}
	...
	\item During the Intro Packet, obtain signatures greater than or equal to 60\% of the number of Active Members, excluding Intro Members, or successfully complete the Intro Eval.
